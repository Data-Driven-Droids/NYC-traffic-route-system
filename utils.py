...
CITY_GUARD_VIEWS: Dict[str, str] = {
    ...
    "SERVICE_CALLS_BY_BOROUGH_CIP": "DEV_PREMIER_LEAGUE.CITY_GUARD.VW_NYPD_SERVICE_CALLS_BY_BOROUGH_CIP",
    "SERVICE_CALLS_BY_BOROUGH_NON_CIP": "DEV_PREMIER_LEAGUE.CITY_GUARD.VW_NYPD_SERVICE_CALLS_BY_BOROUGH_NON_CIP",
    "SERVICE_CALLS_BY_TYPE_NON_CIP": "DEV_PREMIER_LEAGUE.CITY_GUARD.VW_NYPD_SERVICE_CALLS_BY_TYPE_NON_CIP",
...
async def get_nyc_demographics() -> Optional[Dict[str, str]]:
    ...
    Provide birth_rate in 5-6 words only. Don't exceed that.
    For example:
    {
...
async def stream_gemini_response(
    ...
    if active_tools is None:
        ...
        active_tools = [{"google_search": {}}, {"google_maps": {}}]
    if tools is None:
